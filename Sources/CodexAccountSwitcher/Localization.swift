...
enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "switch_provider_body": "Codex Desktop will close and reopen with this provider. New conversations will use it. Existing conversations remain bound to the provider they were created with.",
            "accounts": "Accounts",
            "back": "Back",
        ...
        .simplifiedChinese: [
            ...
            "switch_provider_body": "Codex Desktop 将关闭并使用此提供商重新打开。新对话将使用它；现有对话仍绑定到创建时使用的提供商。",
            "accounts": "账号",
            "back": "返回",
            "add_account": "添加账号",
