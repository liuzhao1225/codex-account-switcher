...
enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "update_check_hint": "Check every hour. A blue dot appears when an update is available. Installing an update restarts Switcher.",
        ...
        .simplifiedChinese: [
            ...
            "update_check_hint": "每小时检查一次，有更新时显示蓝点。安装更新后重启 Switcher。",
