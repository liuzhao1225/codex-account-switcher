...
public enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "provider_responses_notice": "Use a service that supports the Responses API. Fetch models, enable the ones you want, and choose a default with the star.",
            "provider_anthropic_notice": "Codex cannot directly use Anthropic Messages. Use a Responses-compatible gateway to save a usable provider. You can fetch the Anthropic model list here.",
            ...
            "provider_setup_notice": "Add services and manage their models in the provider window. This switch controls whether providers appear in the account list; turning it off does not change the active provider.",
        ...
        .simplifiedChinese: [
            ...
            "provider_setup_notice": "在服务商窗口中添加连接、选择和排序模型。此开关控制账号列表是否显示服务商，关闭后不改变当前服务商。",
