...
| Area | Status |
| --- | --- |
| Apple Silicon build | Available in [v0.1.8](https://github.com/liuzhao1225/codex-account-switcher/releases/tag/v0.1.8) |
...
| DMG release | Available in v0.1.8 |
...
## Automatic updates in 0.1.8

Version 0.1.8 checks hourly through Sparkle. A blue menu-bar dot and an update row above the popover footer indicate a new version; clicking Update starts the framework’s download, installation, and Switcher relaunch flow. Settings provides a manual check and automatic-check toggle. Account operations defer the final relaunch.
